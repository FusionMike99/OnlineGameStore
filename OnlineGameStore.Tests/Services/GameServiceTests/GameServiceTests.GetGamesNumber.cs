...
namespace OnlineGameStore.Tests.Services
{
    public partial class GameServiceTests
    {
        [Theory]
        [AutoMoqData]
        public void GameService_GetGamesNumber_ReturnsGamesNumber(
            List<Game> games,
            ...
            GameService sut)
        {
            ...
            // Act
            var actualGamesNumber = sut.GetGamesNumber(sortFilterGameModel);

            // Assert
            actualGamesNumber.Should().Be(expectedCount);
